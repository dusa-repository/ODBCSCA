...
Module Principal
    ...
    Private Function buscarPedido() As Boolean

        Dim cnn As New System.Data.Odbc.OdbcConnection
        Dim valor As Boolean

        Try

            ' Dim cnn As New Odbc.OdbcConnection("DSN=odbcsca")
            Dim sql As String
            'sql = "select PKHSMAIN.TRANDATE,PKHSMAIN.GENTIME,PKHSMAIN.AREA_ID,PKHSMAIN.PANEL_ID as ID,PKHSMAIN.CARDNO,PKHSMAIN.USER_ID,PKHSMAIN.INPUT_ID,PKCDNTLK.NOTE1 " &
            '"from PKHSMAIN,PKCDNTLK " &
            '"WHERE PKHSMAIN.USER_ID = PKCDNTLK.USERID AND  PKCDNTLK.NOTE1<>'N/A'  AND PKHSMAIN.TRANDATE = '20150925' AND " &
            '      "PKHSMAIN.TRANDATE = '20150930'  "

            cnn.ConnectionString = "DSN=odbcsca"
            cnn.Open()
            ...
            While reader.Read()
                Console.WriteLine(Trim(reader("TRANDATE")))
